...
|---|---|---|---|
| `up/fileutil-defects-f19` | `76485317` | +514/−10, 7 файлов | **ОПУБЛИКОВАНА КАК #3231.** Один non-merge commit прямо на `f19c9d86` после #3226; braces сохранены, `MakeDirectoryTest.php` и `makeDirectory()` не входят в diff. Full PHP 7.4/8.1/8.5: 50 files, 318 methods, 1843 assertions, 127 TAP; PHPStan, 10 mutations, FPM/FIFO/write-only probes и все восемь GitHub checks GREEN; independent review без findings. Текст: `../2026-08-28-fileutil-defects/PR_BODY.md`. |
